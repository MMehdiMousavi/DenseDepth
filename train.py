...
parser.add_argument('--mindepth', type=float, default=0, help='Minimum of input depths')
parser.add_argument('--maxdepth', type=float, default=255, help='Maximum of input depths')
parser.add_argument('--name', type=str, default='Morse_13K', help='A name to attach to the training session')
